...
export var limitNumber = function(num, min, max) {
    return Math.min(max, Math.max(num, min));
};

export var epsilonEquals = function(a, b) {
...
export var createFrameRequester = function(timeStep) {
    var currentCb = null;
    var requester = {};
...
export var getCodeObjFromCode = function(code) {
